...
int main()
{
        ...
        NodeContainer nodes, wirelessRouters;
        //  wiredRouters,
        //  traffic;
        nodes.Create(2);
        ...
        LinuxStackHelper::RunIp(wirelessRouters.Get(0), Seconds(0.2), "route add 10.0.0.1/32 via 10.0.0.2 dev sim1"); // inbound - N0
        // LinuxStackHelper::RunIp(wirelessRouters.Get(0), Seconds(0.2), "route add 10.0.0.3/32 via 10.0.0.4 dev sim2"); // inbound - T0
        //
        LinuxStackHelper::RunIp(wirelessRouters.Get(1), Seconds(0.2), "route add 10.0.0.0/24 via 11.0.0.1 dev sim0"); // outbound - R0 network
        LinuxStackHelper::RunIp(wirelessRouters.Get(1), Seconds(0.2), "route add 10.1.0.1/32 via 10.1.0.2 dev sim1"); // inbound - N1
        // LinuxStackHelper::RunIp(wirelessRouters.Get(1), Seconds(0.2), "route add 10.1.0.3/32 via 10.1.0.4 dev sim2"); // inbound - T1
        ...
        // LinuxStackHelper::RunIp(wiredRouters.Get(0), Seconds(0.2), "route add 10.3.0.0/24 via 11.1.0.1 dev sim0"); // outbound to R3 network
        // LinuxStackHelper::RunIp(wiredRouters.Get(0), Seconds(0.2), "route add 10.2.0.1/32 via 10.2.0.2 dev sim1"); // inbound - N0
        // LinuxStackHelper::RunIp(wiredRouters.Get(0), Seconds(0.2), "route add 10.2.0.3/32 via 10.2.0.4 dev sim2"); // inbound - T2

        // LinuxStackHelper::RunIp(wiredRouters.Get(1), Seconds(0.2), "route add 10.2.0.0/24 via 11.1.0.2 dev sim0"); // outbound to R2 network
        // LinuxStackHelper::RunIp(wiredRouters.Get(1), Seconds(0.2), "route add 10.3.0.1/32 via 10.3.0.2 dev sim1"); // inbound - N1
        // LinuxStackHelper::RunIp(wiredRouters.Get(1), Seconds(0.2), "route add 10.3.0.3/32 via 10.3.0.4 dev sim2"); // inbound - T3
        ...
        LinuxStackHelper::RunIp(nodes.Get(0), Seconds(0.1), "route add default via 10.0.0.2 dev sim0");
        ...
        // setting default route
        LinuxStackHelper::RunIp(nodes.Get(1), Seconds(0.1), "route add default via 10.1.0.2 dev sim0");
